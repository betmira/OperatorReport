...
namespace Powerfront.Database
{
    ...
    public partial class chatEntities : DbContext
    {
        ...
        public virtual ObjectResult<OperatorProductivity_Result> OperatorProductivity(string website, Nullable<int> visitorID, Nullable<System.DateTime> startDate, Nullable<System.DateTime> endDate)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<OperatorProductivity_Result>("OperatorProductivity", websiteParameter, visitorIDParameter, startDateParameter, endDateParameter);
        }
    }
}
